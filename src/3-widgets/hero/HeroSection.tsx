      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-12 lg:py-24">
        <div>
          ...
          <h1 className="max-w-2xl text-5xl font-extrabold leading-[0.98] tracking-[-0.05em] text-[#0D2734] sm:text-6xl lg:text-7xl">
            ...
            <span className="mt-2 block">bliže cilju.</span>
          </h1>

          <p className="mt-7 max-w-xl text-base leading-7 text-[#6D7475] sm:text-lg">
            Izaberi mesto na zajedničkoj slici i pretvori ga u konkretnu pomoć.
            Svaki piksel ostavlja trajni trag dobrote.
          </p>

          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a
              href="#srce"
              className="inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl bg-[#D6384B] px-7 text-sm font-bold text-white shadow-[0_12px_30px_rgba(214,56,75,0.22)] transition hover:-translate-y-0.5 hover:bg-[#BF2F41] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D6384B] focus-visible:ring-offset-2"
            >
              Izaberi svoj piksel
            ...
            <a
              href="#kako-radi"
              className="inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl border-2 border-[#0D2734] px-7 text-sm font-bold text-[#0D2734] transition hover:bg-[#0D2734] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0D2734] focus-visible:ring-offset-2"
            >
              Saznaj više
              <span aria-hidden="true">→</span>
            </a>
          ...
          <dl className="mt-12 grid max-w-lg grid-cols-2 divide-x divide-[#0D2734]/15">
            <div className="pr-6">
              <dt className="text-xs text-[#6D7475]">Prikupljeno do sada</dt>
            ...
            <div className="pl-6">
              <dt className="text-xs text-[#6D7475]">Izabranih piksela</dt>
              <dd className="mt-1 text-xl font-extrabold tracking-tight text-[#0D2734] sm:text-2xl">
                2.348
              </dd>
            </div>
        ...
        <div className="mx-auto w-full max-w-xl rounded-[2rem] bg-white p-5 shadow-[0_24px_70px_rgba(13,39,52,0.14)] sm:p-8">
          ...
          <div
            ...
            role="progressbar"
            aria-label="Popunjenost zajedničke slike"
            aria-valuemin={0}
            aria-valuemax={100}
            aria-valuenow={58}
          >
            <div className="h-full w-[58%] rounded-full bg-[#D6384B]" />
          </div>
          ...
          <div className="mt-2 flex flex-wrap items-center justify-between gap-4 text-xs text-[#6D7475]">
            <div className="flex items-center gap-4">
              <span className="inline-flex items-center gap-2">
                <span className="h-3 w-3 rounded-sm bg-[#D6384B]" />
                Zauzeto
              </span>

              <span className="inline-flex items-center gap-2">
                <span className="h-3 w-3 rounded-sm bg-[#F3E4DB]" />
                Slobodno
              </span>
            </div>
            ...
            <a
              href="#srce"
              className="font-bold text-[#0D2734] transition hover:text-[#D6384B]"
            >
              Klikni na slobodan piksel →
            </a>
          </div>
        </div>
      </div>
